...
Elm.Main.make = function (_elm) {
   ...
   content) {
      ...
      _L.fromArray([A2($Html.div,
                   _L.fromArray([fieldNameStyle("160px")]),
                   _L.fromArray([$Html.text(name)]))
                   ,A2($Html.input,
                   _L.fromArray([$Html$Attributes.type$(fieldType)
      ...
      return function () {
         ...
         {case "Name":
            ...
            return _U.replace([["password"
              ...
              model);
            case "PasswordAgain":
            return _U.replace([["passwordAgain"
                               ,action._0]],
              model);}
         _U.badCase($moduleName,
   ...
   model) {
      return function () {
         var validationMessage = _U.eq($String.length(model.password),
         0) && _U.eq($String.length(model.passwordAgain),
         0) ? A2($Html.span,
         _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                            ,_0: "color"
                                                            ,_1: "green"}]))]),
         _L.fromArray([$Html.text("Please enter a password")])) : _U.eq(model.password,
         model.passwordAgain) ? A2($Html.span,
         _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                            ,_0: "color"
                                                            ,_1: "green"}]))]),
         _L.fromArray([$Html.text("Passwords Match!")])) : A2($Html.span,
         _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                            ,_0: "color"
                                                            ,_1: "red"}]))]),
         _L.fromArray([$Html.text("Passwords do not match :(")]));
         return A2($Html.div,
         _L.fromArray([]),
         _L.fromArray([A5(field,
                      "text",
                      address,
                      Name,
                      "User Name",
                      ...
                      model.passwordAgain)
                      ,A2($Html.div,
                      _L.fromArray([fieldNameStyle("300px")]),
                      _L.fromArray([validationMessage]))]));
      }();
   });
